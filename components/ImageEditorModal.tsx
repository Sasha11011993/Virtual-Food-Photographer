      ...
      <div className="bg-brand-secondary rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto" role="dialog" aria-modal="true">
        <div className="p-6">
          <div className="flex justify-between items-start">
            <div>
              <h2 className="text-2xl font-serif font-bold text-brand-accent">Редагувати Фотографію</h2>
          ...
          <div className="mt-6">
            <img src={imageUrl} alt={`Editing ${dish.name}`} className="w-full rounded-lg aspect-video object-contain bg-brand-primary" />
          </div>

          <div className="mt-6 space-y-4">
            <label htmlFor="edit-prompt" className="block text-sm font-medium text-brand-subtle">Опишіть ваше редагування:</label>
            <input
              id="edit-prompt"
              type="text"
              value={prompt}
              onChange={(e) => setPrompt(e.target.value)}
              placeholder="напр., 'Додай трохи петрушки' або 'Зроби фото у вінтажному стилі'"
